...
import { useAdminDashboard } from "../dashboards/useDashboard.admin";
    ...
    <Group justify="space-between" align="flex-start">
      <Box>
        <Text
          ...
          tt="uppercase"
          fw={600}
          style={{ color: "rgba(255,255,255,0.8)", letterSpacing: 1 }}
        >
          {title}
        </Text>
        <Text
          size="xl"
          fw={700}
          style={{ color: "#ffffff", fontSize: 28, marginTop: 8 }}
        >
          {value}
        </Text>
        {subtitle && (
          ...
          <Group justify="space-between" align="center" mb={32}>
            <Box>
              ...
              <Text style={{ color: COLORS.text.tertiary, marginTop: 8 }}>
                Kelola dan monitor sistem affiliate
              </Text>
            </Box>
            <Badge
              size="lg"
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              ...
              >
                ...
                {pendingApprovals.length === 0 ? (
                  ...
                  pendingApprovals.map((item: { label: string; count: number; amount: string; status: "pending" | "approved" | "rejected" }, index: number) => (
                    <ApprovalItem
                      key={index}
                      label={item.label}
                      count={item.count}
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              ...
              >
                ...
                <Box mb={20}>
                  ...
                  <Progress
                    value={(stats.activeMembers / stats.totalMembers) * 100 || 0}
                    color="green"
                    size="md"
                    radius="xl"
                  />
              ...
              >
                ...
                {recentActivity.map((activity: { type: "approval" | "withdrawal" | "commission"; title: string; time: string }, index: number) => (
                  <Group
                    key={index}
                    mb={12}
                    style={{
