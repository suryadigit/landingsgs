...
import WithdrawalApprovalTab from "../approvalPencairan/WithdrawalApprovalTab";
  ...
  return (
    <Stack gap={16} p="md">
      ...
      <Paper
        ...
        withBorder
        style={{
          backgroundColor: isDark ? COLORS.bg.tertiary : "#f8fafc",
...
const ApprovalByAdmin: React.FC = () => {
  ...
  // State untuk menyimpan nominal approve per user
  const [approveAmounts, setApproveAmounts] = useState<Record<string, number>>({});
  const [approvingUser, setApprovingUser] = useState<string | null>(null);

  // Handler untuk update amount per user
  ...
  // Handler untuk approve user dengan nominal tertentu
  const handleApproveUser = async (affiliate: GroupedAffiliate) => {
    ...
    try {
      // Approve komisi satu per satu sampai mencapai nominal
  ...
  const content = (
    ...
    >
              ...
              <Accordion
                ...
                styles={{
                  ...
                  control: {
                    padding: "16px",
                    "&:hover": {
                      backgroundColor: isDark ? COLORS.bg.tertiary : "#f1f5f9",
                    },
                  },
                  content: {
                    padding: 0,
              ...
              >
                {groupedAffiliates.map((affiliate) => (
                  <Accordion.Item key={affiliate.affiliateCode} value={affiliate.affiliateCode}>
                    <Accordion.Control>
                      <Text fw={600} style={{ color: COLORS.text.primary, fontSize: 16 }}>
      ...
      <Modal
        ...
        title={
          <Text fw={700} style={{ color: COLORS.text.primary }}>
            Reject Komisi
          </Text>
        }
        centered
