...
import { STATUS_FILTER_OPTIONS } from '../constants/commissionConstants';
import type { Commission } from '../types/commissionTypes';
...
const CommissionPage: React.FC = () => {
  ...
  const content = (
    <Box style={{ paddingInlineStart: '10px', backgroundColor: dark ? "#0d0d0d" : COLORS.bg.primary, minHeight: '100vh' }}>
      <Container size="xl">
          ...
          >
            {isLoading ? (
              <Box style={{ padding: 20 }}>
                <Skeleton height={20} width="30%" radius="sm" mb={12} />
