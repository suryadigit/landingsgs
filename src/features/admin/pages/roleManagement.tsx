...
import type { RoleType } from '../../../features/roles';
                        ...
                        {memberMenus.map((menu) => (
                          ...
                          >
                            <Checkbox
                              label={
                                <Box>
                                  <Text size="sm" fw={500} c={COLORS.text.primary}>{menu.label}</Text>
                                  <Text size="xs" c={COLORS.text.tertiary}>{menu.link}</Text>
                                </Box>
                              }
                      ...
                      <SimpleGrid cols={{ base: 1, sm: 2, md: 3, lg: 4 }} spacing="sm">
                        {perms.map((perm) => (
                          ...
                          >
                            <Checkbox
                              label={
                                <Text size="sm" c={COLORS.text.primary}>{perm.name}</Text>
                              }
